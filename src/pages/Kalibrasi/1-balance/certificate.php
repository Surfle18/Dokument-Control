...
<div class="fill">
    <div class="dread">
        <div class="crumb">
            ...
            <a class="link-dark link-offset-2 link-underline-opacity-0 link-underline-opacity-100-hover" href="balance.php">> BALANCE</a>      
            <a class="link-dark link-offset-2 link-underline-opacity-0 link-underline-opacity-100-hover" href=" certificate.php">> CERTIFICATE-BALANCE</a>
        </div>
    </div>
<div class="page">
    <div class="data-sch">
    ...
    <?php 
        ...
        $data = mysqli_query($conn, "SELECT * FROM balance_handover LIMIT $limit OFFSET $offset");
    ...
    <tr>
        ...
        <td>
        <a class="link-danger link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover" href="page-system/view-certificate.php?id=<?php echo $view['id']; ?>">
                <i class="bi bi-download"></i></i>
            </a> | 
            <a class="link-danger link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover" href="../../../system/balance/delete-data-certificate.php?id=<?php echo $view['id']; ?>">
    ...
    <?php
    $total_query = "SELECT COUNT(*) AS total FROM balance_handover";
