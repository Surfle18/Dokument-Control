...
<div class="fill">
    <div class="dread">
        <div class="crumb">
            ...
            <a class="link-dark link-offset-2 link-underline-opacity-0 link-underline-opacity-100-hover" href=" handover.php">> HANDOVER-BALANCE</a>
        </div>
    </div>
<div class="page">
    <div class="data-sch">
    ...
    <tr>
        ...
        <td>
            <a class="link-danger link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover" href="page-system/view-handover.php?id=<?php echo $view['id']; ?>">
