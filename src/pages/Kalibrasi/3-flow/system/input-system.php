...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO schedule_flowmeter (departemen_pemilik, nama_alat, kode_alat, merk_alat, tipe, lokasi_alat, nomor_kalibrasi, resolusi, pembacaan_terkecil, kapasitas, kapasitas_alat, range_penggunaan_alat, limits_of_permissible_error, relates_form_balances) 
