...
<head>
    ...
    <title>schedule flowmeter</title>
...
<div class="dread">
        <div class="crumb">
            ...
            <a class="link-dark link-offset-2 link-underline-opacity-0 link-underline-opacity-100-hover" href="flow.php?token=<?php echo htmlspecialchars($_SESSION['token']); ?>">> FLOWMETER</a>            
            <a class="link-dark link-offset-2 link-underline-opacity-0 link-underline-opacity-100-hover" href="schedule.php">> SCHEDULE-FLOWMETER</a>
        </div>
        <hr>
</div>
<div class="page">
...
<table class="table table-striped table-hover">
    ...
    require_once 'config/config2.php';
     ...
     $sql = "SELECT * FROM schedule_flowmeter";
    ...
    echo '<a href="" adata-bs-toggle="popover" data-bs-title="Popover title" data-bs-content="And heres some amazing content. Its very engaging. Right?">';
    echo '<tr>';
                echo '<td>' . $counter . '</td>';
