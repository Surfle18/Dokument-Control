...
if (isset($_GET['id'])) {
    ...
    $query = "SELECT * FROM instrument_handover WHERE id = ?";
    ...
    $pdf->SetLineWidth(0.4);
    $pdf->Rect(7.6, 79.5, $pdf->getPageWidth() - 15.9, $pdf->getPageHeight() - 165);
...
<tr><td  style="line-height: 10px"></td></tr>
    <tr>
        ...
        <td class="border" width="110px" style="line-height: 10px; text-align: center;"><span class="metode">Pembacaan Alat yang Dikalibrasi</span></td>
        <td class="border" width="105px" style="line-height: 10px; text-align: center;"><span class="metode">Pembacaan Alat Standar</span></td>
        <td class="border" width="105px" style="line-height: 20px; text-align: center;"><span class="metode">Koreksi</span></td>
...
<table>
    <tr>
        <td width="16px" style="line-height: 202px;"></td>
    </tr>
    <tr>
        <td></td>
    ...
    <tr>
        <td></td>
        <td><span>Hasil Kalibrasi Yang Dilaporkan Tertelusur Di NIST.</span></td>
    </tr>
    <tr>
        <td></td>
