  ...
  <div class="dread">       
      <div class="crumb">   
          <div class="rumb">
              ...
              <a class="link-dark link-offset-2 link-underline-opacity-0 link-underline-opacity-100-hover" href="certificate.php">> CERTIFICATE</a>
          </div>
      </div>
  </div>
<div class="page">
...
$sql = "SELECT * FROM instrument_handover WHERE 1";
...
if ($result && $result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
      ...
      echo '<td><a class="link-danger link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover" href="../../../system/temprature/delete-data-handover.php?id=' . htmlspecialchars($row['id']) . '"><i class="bi bi-trash-fill"></i></a></td>';
      echo "</tr>";
      $counter++;
    }
      echo "</table>";
