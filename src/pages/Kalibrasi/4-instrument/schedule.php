...
<head>
      ...
      <title>schedule-instrument</title>
            ...
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="formFlowmeter" method="post" action="../../../system/instrument/input-system.php">
  ...
  <div class="dread">       
      <div class="crumb">   
          <div class="rumb">
              ...
              <a class="link-dark link-offset-2 link-underline-opacity-0 link-underline-opacity-100-hover" href="schedule.php">> SCHEDULE-INSTRUMENT</a>
          </div>
          <div class="delet">    
              <button id="selectedall" class="btn btn-warning btn-sm">Check Al</button>
              <form method="post" action="../../../system/instrument/delete.php" id="form-delete">   
...
$sql = "SELECT * FROM instrument_schedule WHERE 1";
