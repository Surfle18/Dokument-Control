...
<head>
      ...
      <title>schedule-temprature</title>
            ...
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="formFlowmeter" method="post" action="../../../system/temprature/input-system.php">
                            <label for="departemen_pemilik">DEPARTEMEN PEMILIK</label><br>
                            <input class="form-control" type="text" name="departemen_pemilik" placeholder="maks 25 charakter" id="departemen_pemilik"><br>
                
                            <label for="nama_alat">NAMA ALAT</label><br>
                            <input class="form-control" type="text" name="nama_alat" placeholder="maks 25 charakter" id="nama_alat"><br>
                
                            <label for="kode_alat">KODE ALAT</label><br>
                            <input class="form-control" type="text" name="kode_alat" placeholder="maks 25 charakter" id="kode_alat"><br>
                
                            <label for="merk_alat">MERK ALAT</label><br>
                            <input class="form-control" type="text" name="merk_alat" placeholder="maks 25 charakter" id="merk_alat"><br>
                
                            <label for="tipe">TIPE</label><br>
                            <input class="form-control" type="text" name="tipe" placeholder="maks 25 charakter" id="tipe"><br>
                
                            <label for="lokasi_alat">LOKASI ALAT</label><br>
                            <input class="form-control" type="text" name="lokasi_alat" placeholder="maks 25 charakter" id="lokasi_alat"><br>
                
                            <label for="nomor_kalibrasi">NOMOR KALIBRASI</label><br>
                            <input class="form-control" type="text" name="nomor_kalibrasi" placeholder="maks 25 charakter" id="nomor_kalibrasi"><br>

                            <label for="resolusi">RESOLUSI</label><br>
                            <input class="form-control" type="text" name="resolusi" placeholder="maks 25 charakter" id="resolusi"><br>
                
                            <label for="pembacaan_terkecil">PEMBACAAN TERKECIL</label><br>
                            <input class="form-control" type="text" name="pembacaan_terkecil" placeholder="maks 25 charakter" id="pembacaan_terkecil"><br>
                
                            <label for="kapasitas">KAPASITAS</label><br>
                            <input class="form-control" type="text" name="kapasitas" placeholder="maks 25 charakter" id="kapasitas"><br>
                
                            <label for="kapasitas_alat">KAPASITAS ALAT(gram)</label><br>
                            <input class="form-control" type="text" name="kapasitas_alat" placeholder="maks 25 charakter" id="kapasitas_alat"><br>
                
                            <label for="range_penggunaan">RANGE PENGGUNAAN ALAT</label><br>
                            <input class="form-control" type="text" name="range_penggunaan_alat" placeholder="maks 25 charakter" id="range_penggunaan_alat"><br>
                
                            <label for="limits_of_permissible_error">LIMITS OF PESSIBLE ERROR</label><br>
                            <input class="form-control" type="text" name="limits_of_permissible_error" placeholder="maks 25 charakter" id="limits_of_permissible_error"><br>
                
                            <label for="relates_form_balances">RELATED FORM BALANCEs</label><br>
                            <input class="form-control" type="text" name="relates_form_balances" placeholder="maks 25 charakter" id="relates_form_balances"><br>
                    </div>
  ...
  <div class="dread">       
      <div class="crumb">   
          <div class="rumb">
              ...
              <a class="link-dark link-offset-2 link-underline-opacity-0 link-underline-opacity-100-hover" href="schedule.php">> SCHEDULE-TEMPRATURE</a>
          </div>
          <div class="delet">    
              <button id="selectedall" class="btn btn-warning btn-sm">Check Al</button>
              <form method="post" action="../../../system/temprature/delete.php" id="form-delete">   
...
$sql = "SELECT * FROM temprature_schedule WHERE 1";
