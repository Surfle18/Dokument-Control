...
<div class="page">
    <a href="certificate.php?token=<?php echo htmlspecialchars($_SESSION['token']); ?>" class="link-dark link-underline link-underline-opacity-0">
        <div class="box">
            ...
            <div class="name">CERTIFICATE-TEMPRATURE</div>
        </div>
    </a>
    ...
    <!-- <a href="form-oven.php?token=<?php echo htmlspecialchars($_SESSION['token']); ?>" class="link-dark link-underline link-underline-opacity-0">
        <div class="box">
            <i class="bi bi-file-earmark-ruled" style="font-size: 70px;"></i>
            <div class="name">TEMPRATURE(Oven)</div>
        </div>
    </a>
    <a href="form-hygro.php?token=<?php echo htmlspecialchars($_SESSION['token']); ?>" class="link-dark link-underline link-underline-opacity-0">
        <div class="box">
            <i class="bi bi-file-earmark-ruled" style="font-size: 70px;"></i>
            <div class="name"><marquee behavior="" direction="">TEMPRATURE(ThermoHygro)</marquee></div>
        </div>
    </a> -->
    <a href="handover.php?token=<?php echo htmlspecialchars($_SESSION['token']); ?>" class="link-dark link-underline link-underline-opacity-0">
        <div class="box">
            ...
            <div class="name">HANDOVER-TEMPRATURE</div>
        </div>
    </a>
    <a href="master.php?token=<?php echo htmlspecialchars($_SESSION['token']); ?>" class="link-dark link-underline link-underline-opacity-0">
        <div class="box">
            ...
            <div class="name">MASTER-TEMPRATURE</div>
        </div>
    </a>
    <a href="schedule.php?token=<?php echo htmlspecialchars($_SESSION['token']); ?>" class="link-dark link-underline link-underline-opacity-0">
        <div class="box">
            ...
            <div class="name">SCHEDULE-TEMPRATURE</div>
        </div>
    </a>
