...
<head>
    ...
    <title>form-pdf(temprature)</title>
...
<div class="fill">
    <div class="dread">
        <div class="crumb">
            ...
            <a class="link-dark link-offset-2 link-underline-opacity-0 link-underline-opacity-100-hover" href=" form-pdf.php">> FORM-TEMPRATURE</a>
        </div>
    </div>
<div class="page">
    <div class="data-sch">
