                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <form id="formFlowmeter" action="../../../system/save_exel.php">
                                    <input class="form-control" type="hidden" name="departemen_pemilik"
                                        id="departemen_pemilik">
                                    ...
                                    <input class="form-control" type="hidden" name="pembacaan_terkecil"
                                        id="pembacaan_terkecil">
                                    ...
                                    <input class="form-control" type="hidden" name="range_penggunaan"
                                        id="range_penggunaan">

                                    <input class="form-control" type="hidden" name="limits_of_permissible_error"
                                        id="limits_of_permissible_error">

                                    <input class="form-control" type="hidden" name="relates_form_balances"
                                        id="relates_form_balances">
        ...
        <div class="fill">
            <div class="dread">
                <div class="crumb">
                    ...
                    <a class="link-dark link-offset-2 link-underline-opacity-0 link-underline-opacity-100-hover" href=" form-oven.php">> FORM-TEMPRATURE (Oven)</a>
                </div>
            </div>
            <div class="page">
                <br>

                <form style="margin-top: 30px;" id="inputForm" class="inputForm" action="../../../system/temprature/send_email1.php" method="POST">
                            ...
                            <form class="upper-tab" action="">
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td>:</td>
                                        <td><input class="border gryn input-h" id="lok_kal2" name="lok_kal2" type="text"></td>
                                    </tr>
                                    <tr>
                                        <td>Suhu Ruangan</td>
                                        <td>:</td>
                                        <td><input class="border gryn input-h" id="suh2" name="suh2" type="text"></td>
                                    </tr>
                                    <tr>
                                        <td>Kelembaban</td>
                                        <td>:</td>
                                        <td><input class="border gryn input-h" id="kel2" name="kel2" type="text"></td>
                                    </tr>
                                </table>
                        </div>
                        ...
                        <div class="up2">
                            <table>
                                ...
                                <tr>
                                    <td>Tgl. Kalibrasi </td>
                                    <td>:</td>
                                    <td><input class="gryn input-h" id="tanggal_kalibrasi2" name="tanggal_kalibrasi2"
                                            type="date"></td>
                                </tr>
                                <tr>
                                    <td>Tgl. Kalibrasi Ulang</td>
                                    <td>:</td>
                                    <td><input class="gryn input-h" id="tanggal_kalibrasi_ulang2"
                    ...
                    <div class="btnfit">
                        <div>
                            <button type="button" class="btn btn-outline-secondary" id="Button-A" onclick="visibility1()">Hitungan 1</button>
                            <button type="button" class="btn btn-outline-secondary" id="Button-B" onclick="visibility2()">Hitungan 2</button>
                    ...
                    <div class="btnmenu">
                        ...
                        <div class="dwonbtn">
                            ...
                            <button class="btn btn-success" type="button" onclick="hapusBaris(), ambilNilaiBerdasarkanId()"><i class="bi bi-dash"></button>
                        </div>
                    </div>
                    ...
                    <div class="tekanan" id="tekananturun">
                        ...
                        <div class="email">
                            <table>
                                ...
                                <tr>
                                    <td>
                                        <select class="form-select form-select-sm" aria-label="Small select example" id="email1" name="email1">
                                ...
                                <tr>
                                    <td>
                                        <select class="form-select form-select-sm" aria-label="Small select example" id="email2" name="email2">
                                        <option selected>Supervisor</option>
                                        <option value="wexsurf070@gmail.com">wexsurf070@gmail.com</option>
                                        <option value="fakhrifuadridwan@gmail.com">fakhrifuadridwan@gmail.com</option>
                                        <option value="pklsmk5bisa@gmail.com">pklsmk5bisa@gmail.com</option>
                                        </select>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td>
                                        <select class="form-select form-select-sm" aria-label="Small select example" id="email3" name="email3">
                                ...
                                <tr>
                                    <td>
                                        <select class="form-select form-select-sm" aria-label="Small select example" id="email4" name="email4">
