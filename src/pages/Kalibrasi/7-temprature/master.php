...
<div class="fill">
    <div class="dread">
        <div class="crumb">
            ...
            <a class="link-dark link-offset-2 link-underline-opacity-0 link-underline-opacity-100-hover" href=" master.php">> MATER-TEMPRATURE</a>
        </div>
    </div>
<div class="page">
    <div class="data-sch">
    <div class="data-sch">
        <table class="table table-bordered table-striped">
            ...
            <?php 
                ...
                $data = mysqli_query($conn,"select * from temprature_massa");
