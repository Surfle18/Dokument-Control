...
<head>
      ...
      <title>schedule-volumetrik</title>
            ...
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="formFlowmeter" method="post" action="../../../system/volumetrik/input-system.php">
                        <label for="departemen_pemilik">DEPARTEMEN PEMILIK</label><br>
                            <input class="form-control" type="text" maxlength="25" name="departemen_pemilik" placeholder="maks 25 charakter" id="departemen_pemilik"><br>
                
                            <label for="nama_alat">NAMA ALAT</label><br>
                            <input class="form-control" type="text" maxlength="25" name="nama_alat" placeholder="maks 25 charakter" id="nama_alat"><br>
                
                            <label for="kode_alat">KODE ALAT</label><br>
                            <input class="form-control" type="text" maxlength="25" name="kode_alat" placeholder="maks 25 charakter" id="kode_alat"><br>
                
                            <label for="merk_alat">MERK ALAT</label><br>
                            <input class="form-control" type="text" maxlength="25" name="merk_alat" placeholder="maks 25 charakter" id="merk_alat"><br>
                
                            <label for="tipe">TIPE</label><br>
                            <input class="form-control" type="text" maxlength="25" name="tipe" placeholder="maks 25 charakter" id="tipe"><br>
                
                            <label for="lokasi_alat">LOKASI ALAT</label><br>
                            <input class="form-control" type="text" maxlength="25" name="lokasi_alat" placeholder="maks 25 charakter" id="lokasi_alat"><br>
                
                            <label for="nomor_kalibrasi">NOMOR KALIBRASI</label><br>
                            <input class="form-control" type="text" maxlength="25" name="nomor_kalibrasi" placeholder="maks 25 charakter" id="nomor_kalibrasi"><br>

                            <label for="resolusi">RESOLUSI</label><br>
                            <input class="form-control" type="text" maxlength="25" name="resolusi" placeholder="maks 25 charakter" id="resolusi"><br>
                
                            <label for="pembacaan_terkecil">PEMBACAAN TERKECIL</label><br>
                            <input class="form-control" type="text" maxlength="25" name="pembacaan_terkecil" placeholder="maks 25 charakter" id="pembacaan_terkecil"><br>
                
                            <label for="kapasitas">KAPASITAS</label><br>
                            <input class="form-control" type="text" maxlength="25" name="kapasitas" placeholder="maks 25 charakter" id="kapasitas"><br>
                
                            <label for="kapasitas_alat">KAPASITAS ALAT(gram)</label><br>
                            <input class="form-control" type="text" maxlength="25" name="kapasitas_alat" placeholder="maks 25 charakter" id="kapasitas_alat"><br>
                
                            <label for="range_penggunaan">RANGE PENGGUNAAN ALAT</label><br>
                            <input class="form-control" type="text" maxlength="25" name="range_penggunaan_alat" placeholder="maks 25 charakter" id="range_penggunaan_alat"><br>
                
                            <label for="limits_of_permissible_error">LIMITS OF PESSIBLE ERROR</label><br>
                            <input class="form-control" type="text" maxlength="25" name="limits_of_permissible_error" placeholder="maks 25 charakter" id="limits_of_permissible_error"><br>
                
                            <label for="relates_form_balances">RELATED FORM BALANCEs</label><br>
                            <input class="form-control" type="text" maxlength="25" name="relates_form_balances" placeholder="maks 25 charakter" id="relates_form_balances"><br>
                    </div>
    ...
    <div id="collapseOne" class="accordion-collapse collapse show" data-bs-parent="#accordionExample">
        <div class="accordion-body">
            ...
            <form style="display: flex; justify-content:right;" action="schedule.php" method="GET">
                <input class="form-control" id="departemen_pemilik" name="departemen_pemilik" placeholder="Departemen" type="text"> 
  ...
  <div class="accordion-item">
    ...
    <div id="collapse4" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
        <div class="accordion-body">
            ...
            <form style="display: flex; justify-content:right;" action="schedule.php" method="GET">
                <input class="form-control" id="lokasi_alat" name="lokasi_alat" placeholder="Lokasi Alat" type="text"> 
                <input class="btn btn-primary" type="submit" value="Search">
            </form>
...
<div class="accordion-item">
    ...
    <div id="collapse5" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
        <div class="accordion-body">
            ...
            <form style="display: flex; justify-content:right;" action="schedule.php" method="GET">
                <input class="form-control" id="nomor_kalibrasi" name="nomor_kalibrasi" placeholder="Nomor Kalibrasi" type="text"> 
                <input class="btn btn-primary" type="submit" value="Search">
            </form>
  ...
  <div class="accordion-item">
    ...
    <div id="collapse7" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
        <div class="accordion-body">
            ...
            <form style="display: flex; justify-content:right;" action="schedule.php" method="GET">
                <input class="form-control" id="pembacaan_terkecil" name="pembacaan_terkecil" placeholder="Pembacaan Terkecil" type="text"> 
                <input class="btn btn-primary" type="submit" value="Search">
            </form>
  ...
  <div class="accordion-item">
    ...
    <div id="collapse10" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
        <div class="accordion-body">
            ...
            <form style="display: flex; justify-content:right;" action="schedule.php" method="GET">
                <input class="form-control" id="kapasitas_alat" name="kapasitas_alat" placeholder="Kapasitas Alat" type="text"> 
                <input class="btn btn-primary" type="submit" value="Search">
            </form>
  ...
  <div class="accordion-item">
    ...
    <div id="collapse11" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
        <div class="accordion-body">
            ...
            <form style="display: flex; justify-content:right;" action="schedule.php" method="GET">
                <input class="form-control" id="range_penggunaan_alat" name="range_penggunaan_alat" placeholder="Range Penggunaan Alat" type="text"> 
                <input class="btn btn-primary" type="submit" value="Search">
            </form>
  ...
  <div class="accordion-item">
    ...
    <div id="collapse12" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
        <div class="accordion-body">
            ...
            <form style="display: flex; justify-content:right;" action="schedule.php" method="GET">
                <input class="form-control" id="limits_of_permissible_error" name="limits_of_permissible_error" placeholder="limits of permissible error" type="text"> 
                <input class="btn btn-primary" type="submit" value="Search">
            </form>
  ...
  <div class="accordion-item">
    ...
    <div id="collapse13" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
        <div class="accordion-body">
            ...
            <form style="display: flex; justify-content:right;" action="schedule.php" method="GET">
                <input class="form-control" id="relates_form_balances" name="relates_form_balances" placeholder=" Related Form Balance" type="text"> 
                <input class="btn btn-primary" type="submit" value="Search">
            </form>
  ...
  <div class="dread">       
      <div class="crumb">   
          <div class="rumb">
              ...
              <a class="link-dark link-offset-2 link-underline-opacity-0 link-underline-opacity-100-hover" href="schedule.php">> SCHEDULE-VOLUMETRIK</a>
          </div>
          <div class="delet">    
              <button id="selectedall" class="btn btn-warning btn-sm">Check Al</button>
              <form method="post" action="../../../system/volumetrik/delete.php" id="form-delete">   
              <button class="btn btn-danger btn-sm" type="submit" onclick="return confirm('Apakah Anda yakin ingin menghapus data yang tercentang?')">Delete</button>
          </div>
      </div>
  </div>
<div class="page">
...
else  {$limits_of_permissible_error = '';}

// related form balance
if (isset($_GET['relates_form_balances']))
      {$relates_form_balances = $_GET['relates_form_balances'];} 
else  {$relates_form_balances = '';}

$sql = "SELECT * FROM volumetrik_schedule WHERE 1";
