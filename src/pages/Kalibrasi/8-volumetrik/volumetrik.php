...
<div class="page">
    <a href="schedule.php?token=<?php echo htmlspecialchars($_SESSION['token']); ?>" class="link-dark link-underline link-underline-opacity-0">
        <div class="box">
            ...
            <div class="name">SCHEDULE-VOLUMETRIK</div>
        </div>
    </a>
    <a href="form.php?token=<?php echo htmlspecialchars($_SESSION['token']); ?>" class="link-dark link-underline link-underline-opacity-0">
        <div class="box">
            ...
            <div class="name">VOLUMETRIK(Pipet)</div>
        </div>
    </a>
    <a href="form-pikno.php?token=<?php echo htmlspecialchars($_SESSION['token']); ?>" class="link-dark link-underline link-underline-opacity-0">
        <div class="box">
            <i class="bi bi-file-earmark-ruled" style="font-size: 70px;"></i>
            <div class="name">VOLUMETRIK(Pikno)</div>
        </div>
    </a>
    ...
    <a href="certificate.php?token=<?php echo htmlspecialchars($_SESSION['token']); ?>" class="link-dark link-underline link-underline-opacity-0">
        <div class="box">
            ...
            <div class="name">CERTIFICATE-VOLUMETRIK</div>
        </div>
    </a>
    <a href="master.php?token=<?php echo htmlspecialchars($_SESSION['token']); ?>" class="link-dark link-underline link-underline-opacity-0">
        <div class="box">
            ...
            <div class="name">MASTER-VOLUMETRIK</div>
        </div>
    </a>
    <a href="form-pdf.php?token=<?php echo htmlspecialchars($_SESSION['token']); ?>" class="link-dark link-underline link-underline-opacity-0">
        <div class="box">
            ...
            <div class="name">HANDOVER-VOLUMETRIK</div>
        </div>
    </a>
</div>
</div>
