...
<head>
    ...
    <title>form-pdf(volumetrik)</title>
...
<div class="fill">
    <div class="dread">
        <div class="crumb">
            ...
            <a class="link-dark link-offset-2 link-underline-opacity-0 link-underline-opacity-100-hover" href=" form-pdf.php">> FORM-VOLUMETRIK</a>
        </div>
    </div>
<div class="page">
    <div class="data-sch">
    ...
    <?php 
        ...
        $data = mysqli_query($conn, "SELECT * FROM temprature_handover LIMIT $limit OFFSET $offset");
...
$total_query = "SELECT COUNT(*) AS total FROM temprature_handover";
