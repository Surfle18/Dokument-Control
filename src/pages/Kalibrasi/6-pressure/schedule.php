...
if (isset($_GET['alert'])) {
    ...
    if ($alert === 'duplikat') {
        $message = 'Schedule Sudah Terdaftar!';
    } elseif ($alert === 'berhasil') {
            ...
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="formFlowmeter" method="post" action="../../../system/pressure/input-system.php">
  ...
  <div class="dread">       
      <div class="crumb">   
          <div class="rumb">
              ...
              <a class="link-dark link-offset-2 link-underline-opacity-0 link-underline-opacity-100-hover" href="schedule.php">> SCHEDULE-PRESSURE</a>
          </div>
          <div class="delet">    
...
$sql = "SELECT * FROM pressure_schedule WHERE 1";
