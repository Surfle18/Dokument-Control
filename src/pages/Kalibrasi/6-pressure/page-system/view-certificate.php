...
if (isset($_GET['id'])) {
    ...
    $query = "SELECT * FROM pressure_handover WHERE id = ?";
...
<table>
    <tr>
        ...
        <td class="border" style="line-height: 10px;" width="150px"><span class="tdbel metode">Dibuat Tanggal : ' . $row['tanggal_dibuat'] . '</span></td>
    </tr>
    <tr>
        <td width="16px" ></td>
