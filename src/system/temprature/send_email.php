...
// titik kalibrasi
$nan1   = isset($_POST['nan1']) ? $_POST['nan1'] : '';
$nan21  = isset($_POST['nan21']) ? $_POST['nan21'] : '';
$nan41  = isset($_POST['nan41']) ? $_POST['nan41'] : '';
$nan61  = isset($_POST['nan61']) ? $_POST['nan61'] : '';
$nan81  = isset($_POST['nan81']) ? $_POST['nan81'] : '';
$nan101 = isset($_POST['nan101']) ? $_POST['nan101'] : '';
$nan121 = isset($_POST['nan121']) ? $_POST['nan121'] : '';
$nan141 = isset($_POST['nan141']) ? $_POST['nan141'] : '';
$nan161 = isset($_POST['nan161']) ? $_POST['nan161'] : '';
$nan181 = isset($_POST['nan181']) ? $_POST['nan181'] : '';
$nan201 = isset($_POST['nan201']) ? $_POST['nan201'] : '';
$nan221 = isset($_POST['nan221']) ? $_POST['nan221'] : '';
$nan241 = isset($_POST['nan241']) ? $_POST['nan241'] : '';
$nan261 = isset($_POST['nan261']) ? $_POST['nan261'] : '';
$nan281 = isset($_POST['nan281']) ? $_POST['nan281'] : '';

$inline1 = isset($_POST['inline1']) ? $_POST['inline1'] : '';
$inline2 = isset($_POST['inline2']) ? $_POST['inline2'] : '';
$inline3 = isset($_POST['inline3']) ? $_POST['inline3'] : '';
$inline4 = isset($_POST['inline4']) ? $_POST['inline4'] : '';
$inline5 = isset($_POST['inline5']) ? $_POST['inline5'] : '';
$inline6 = isset($_POST['inline6']) ? $_POST['inline6'] : '';
$inline7 = isset($_POST['inline7']) ? $_POST['inline7'] : '';
$inline8 = isset($_POST['inline8']) ? $_POST['inline8'] : '';
$inline9 = isset($_POST['inline9']) ? $_POST['inline9'] : '';
$inline10 = isset($_POST['inline10']) ? $_POST['inline10'] : '';
$inline11 = isset($_POST['inline11']) ? $_POST['inline11'] : '';
$inline12 = isset($_POST['inline12']) ? $_POST['inline12'] : '';
$inline13 = isset($_POST['inline13']) ? $_POST['inline13'] : '';
$inline14 = isset($_POST['inline14']) ? $_POST['inline14'] : '';
$inline15 = isset($_POST['inline15']) ? $_POST['inline15'] : '';
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    alat_rh1, alat_rh2, alat_rh3, alat_rh4, alat_rh5, alat_rh6, alat_rh7, alat_rh8, alat_rh9, alat_rh10, alat_rh11, alat_rh12, alat_rh13, alat_rh14, alat_rh15,
    ...
    standar_rh1, standar_rh2, standar_rh3, standar_rh4, standar_rh5, standar_rh6, standar_rh7, standar_rh8, standar_rh9, standar_rh10, standar_rh11, standar_rh12, standar_rh13, standar_rh14, standar_rh15, 
    ...
    koreksi_rh1, koreksi_rh2, koreksi_rh3, koreksi_rh4, koreksi_rh5, koreksi_rh6, koreksi_rh7, koreksi_rh8, koreksi_rh9, koreksi_rh10, koreksi_rh11, koreksi_rh12, koreksi_rh13, koreksi_rh14, koreksi_rh15,
    ...
    ketidakpastian_rh1, ketidakpastian_rh2, ketidakpastian_rh3, ketidakpastian_rh4, ketidakpastian_rh5, ketidakpastian_rh6, ketidakpastian_rh7, ketidakpastian_rh8, ketidakpastian_rh9, ketidakpastian_rh10, ketidakpastian_rh11, ketidakpastian_rh12, ketidakpastian_rh13, ketidakpastian_rh14, ketidakpastian_rh15) 
   
    VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
    $stmt->bind_param("ssssssssssssssssssssssssssssssssssssssssssssssdddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddd",
    ...
    $bac18, $bac38, $bac58, $bac78, $bac98, $bac118, $bac138, $bac158, $bac178, $bac198, $bac218, $bac238, $bac258, $bac278, $bac298, 
